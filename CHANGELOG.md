...
- Added a development-only guided demonstration using the real evidence and review data model.
...
- Added pilot API-key access, roles, tenant isolation, readiness, security headers, feedback, operator
  metrics, resilience guards, missing-information actions, report disclaimers, and recovery proof.

Earlier milestone details are preserved under `docs/releases/`.
